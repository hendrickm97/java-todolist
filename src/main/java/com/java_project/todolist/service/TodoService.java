package com.java_project.todolist.service;

import com.java_project.todolist.entity.Todo;
import com.java_project.todolist.exception.BadRequestException;
import com.java_project.todolist.repository.TodoRepository;
...
public class TodoService {
    ...
    public List<Todo> delete(Long id){
        todoRepository.findById(id).ifPresentOrElse((existingTodo) -> todoRepository.delete(existingTodo), () -> {
            throw new BadRequestException("Tod %d não existe! ".formatted(id));
        });
        return list();
    }
}
